...
### 🔒 MVP Guardrails
- After completing tasks 1-3 in TASK.md **pause and wait for human approval**.
- **Do not** add Dockerfiles, GitHub Actions, or datasets >50 kB in v0.1.
- **Never commit .env or real keys**; ensure .gitignore covers them.
